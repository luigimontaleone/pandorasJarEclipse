    ...
    <div class="row" id="firstRow">
        <div class="col-xl-7" style="width: 60%;">
            ...
            <div class="row" id="secondRow">
                <div class="col-xl-7" style="width: 60%;">
                    <p class="d-inline" id="pCategory">Questo gioco appartiene alla categoria :</p><!--<a href="/?category=${gameLibrary.category}" style="font-size: 20px;">-->${gameLibrary.category}<!--</a>-->
                </div>
                <div class="col float-left" style="width: 40%;">
